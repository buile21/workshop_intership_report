...
![IAM Trust Entity](/workshop_intership_report/images/5-Workshop/5.4-Messaging-IAM/iam-trust-1.png)
...
![IAM Permissions](/workshop_intership_report/images/5-Workshop/5.4-Messaging-IAM/iam-permissions-2.png)

5. Click **Next**.
6. **Role name**: Enter `idp-lambda-ai-role`.
![IAM Permissions](/workshop_intership_report/images/5-Workshop/5.4-Messaging-IAM/idp-lambda-ai-role.png)
