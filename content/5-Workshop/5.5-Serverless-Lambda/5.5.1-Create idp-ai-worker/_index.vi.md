...
![Khởi tạo Lambda](/workshop_intership_report/images/5-Workshop/5.5-Serverless-Lambda/create-worker.png)
...
![Cấu hình RAM và Timeout](/workshop_intership_report/images/5-Workshop/5.5-Serverless-Lambda/worker-config.png)
...
![Cấu hình Trigger SQS](/workshop_intership_report/images/5-Workshop/5.5-Serverless-Lambda/worker-trigger.png)
