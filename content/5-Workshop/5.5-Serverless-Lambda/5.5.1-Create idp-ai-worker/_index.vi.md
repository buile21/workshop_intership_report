...
![Khởi tạo Lambda](static/images/5-Workshop/5.5-Serverless-Lambda/create-worker.png)
...
![Cấu hình RAM và Timeout](static/images/5-Workshop/5.5-Serverless-Lambda/worker-config.png)
...
![Cấu hình Trigger SQS](static/images/5-Workshop/5.5-Serverless-Lambda/worker-trigger.png)
