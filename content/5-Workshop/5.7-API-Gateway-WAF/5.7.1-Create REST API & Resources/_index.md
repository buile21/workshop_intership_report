...
![Create API Gateway](static/images/5-Workshop/5.7-API-Gateway-WAF/create-api.png)
6. Click **Create API**.
...
![API Gateway Method](static/images/5-Workshop/5.7-API-Gateway-WAF/api-resource.png)
...
![API Gateway Method](static/images/5-Workshop/5.7-API-Gateway-WAF/api-method.png)
