...
![Create WAF](/static/images/5-Workshop/5.7-API-Gateway-WAF/waf-1.png)
...
![Create WAF](/static/images/5-Workshop/5.7-API-Gateway-WAF/waf-2.png) 
...
![Create WAF](/static/images/5-Workshop/5.7-API-Gateway-WAF/waf-3.png)
4. **Rate limit**: Nhập `100` (Hệ thống sẽ tự động chặn IP nếu phát hiện hơn 100 yêu cầu được gửi đến trong vòng 5 phút).
5. **Action**: Chọn **Block**.
![Create WAF](/static/images/5-Workshop/5.7-API-Gateway-WAF/waf-4.png)
![Create WAF](/static/images/5-Workshop/5.7-API-Gateway-WAF/waf-5.png)
