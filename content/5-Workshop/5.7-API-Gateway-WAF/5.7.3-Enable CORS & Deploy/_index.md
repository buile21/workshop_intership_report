...
![Enable CORS](/workshop_intership_report/images/5-Workshop/5.7-API-Gateway-WAF/api-cors.png)
5. Click **Save**.
...
![Deploy API](/workshop_intership_report/images/5-Workshop/5.7-API-Gateway-WAF/deploy-api.png)
4. Click **Deploy**.
...
![Invoke URL](/workshop_intership_report/images/5-Workshop/5.7-API-Gateway-WAF/api-invoke-url.png)
