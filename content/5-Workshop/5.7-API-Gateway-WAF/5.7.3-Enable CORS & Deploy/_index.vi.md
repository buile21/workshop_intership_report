...
![Enable CORS](/workshop_intership_report/images/5-Workshop/5.6-API-Gateway/api-cors.png)
5. Bấm **Save**.
...
![Deploy API](/workshop_intership_report/images/5-Workshop/5.6-API-Gateway/deploy-api.png)
4. Bấm **Deploy**.
...
![Invoke URL](/workshop_intership_report/images/5-Workshop/5.6-API-Gateway/api-invoke-url.png)
